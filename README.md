...
![image-20210820213322067](https://i.loli.net/2021/08/21/6gP5QuJockiSZza.png)
...
- 请求地址
  ...
  ![image-20210820213521158](https://i.loli.net/2021/08/21/rLmYaHR27PSNfGz.png)

  ![image-20210820213537297](https://i.loli.net/2021/08/21/Hd4fRqEBA3C2zgp.png)
...
- 引用内置模块
	...
	- **const {pathname,query}=url.parse(req.url,true)**
		...
		- pathname地址ming
		- query传输来的数据
- 代码![image-20210820213842390](https://i.loli.net/2021/08/21/kdWBO8wuMir9flP.png)
- **post请求参数**
  - 参数被放置在请求体中进行传输
...
![image-20210820214036146](https://i.loli.net/2021/08/21/PB21HcWvxTkMQh5.png)487.png)
...
- 代码
- ![image-20210820214106652](https://i.loli.net/2021/08/21/34B6HrwxqnONXJa.png)
	- 通过writeHead设置编码格式
	- 核心逻辑：
...
- 代码![image-20210820214139697](https://i.loli.net/2021/08/21/LaO4Afdyupg6ZK1.png)
...
- 回调函数
  ...
  - 自己定义函数让别人去调用。
  - ![image-20210820214139697](https://i.loli.net/2021/08/21/QInwtRKfoEAMyzv.png)
...
- 执行顺序
	...
	- 先同步后异步
	- ![image-20210820214545196](https://i.loli.net/2021/08/21/ALV9UHfOGysqNEk.png)

### 4.回调地狱

- 异步api解决顺序问题只能用回调函数嵌套
- 因此容易导致回调地狱
- ![image-20210820214614575](https://i.loli.net/2021/08/21/8ejIrd64mNKFsyg.png)
...
- 例子![image-20210820214645915](https://i.loli.net/2021/08/21/XBJbkEN8PLvlD5r.png)
...
- **await关键字**
	...
	- 代码![image-20210820214707815](https://i.loli.net/2021/08/21/uxRYIlCzFJsSc7N.png)

- **promisify方法**
	- **改造现有异步函数api让其返回promise对象从而支持异步函数语法**
	- **const promisify = require( ' util' ). promisify;**
	- 代码![image-20210820214741923](https://i.loli.net/2021/08/21/m9GuwSjbNLPTeWA.png)

![image-20210820214757376](https://i.loli.net/2021/08/21/OGZlx4aTHIdP7vE.png)
...
- **使用mongoose提供的connect方法即可连接数据库。**
	...
	- 代码![image-20210820214931730](https://i.loli.net/2021/08/21/DW69jOTpd4JyuP2.png)
...
- **在MongoDB中不需要显式创建数据库，如果正在使用的数据库不存在，MongoDB会自动创建。**
  ...
  **1.创建集合**
  ...
  代码![image-20210820215008214](https://i.loli.net/2021/08/21/sK51yY2piSJg34I.png)
  ...
  **2.创建文档**
  ...
  - 第一种方法![image-20210820215021187](https://i.loli.net/2021/08/21/n1aJmG3jh5fkNeH.png)
  - **常用**（第二种方法）![image-20210820215031991](https://i.loli.net/2021/08/21/4ao9xs2vWhinLXt.png)
  ...
  **4.查询数据**
  ...
  - **find里面传递对象作为查找条件**
    ...
    ![image-20210820215839299](https://i.loli.net/2021/08/21/HhcVO2rynl6RuC7.png)
  ...
  - **skip 跳过多少条数据limit 限制查询数量**
    ...
    ![image-20210820220351500](https://i.loli.net/2021/08/21/b6sArgClOBmfMIL.png)
  ...
  **7.验证字段**
  ...
  - 代码![image-20210820220808279](https://i.loli.net/2021/08/21/FQ8EdX4qSGusBVx.png)
  - 获取错误信息![image-20210820220842049](https://i.loli.net/2021/08/21/FlNP3uC6n2DpLMY.png)
  ...
  **8.集合关联**
  ...
  - ![image-20210820220908192](https://i.loli.net/2021/08/21/BpHWDPro2IwOmfZ.png)

  - **代码**

    ![image-20210820220930254](https://i.loli.net/2021/08/21/JYQeUGDPgtXuRNO.png)
...
- ![image-20210820221917093](https://i.loli.net/2021/08/21/4o1ThA6yNtPjH7i.png)
- 图示![image-20210820221929372](https://i.loli.net/2021/08/21/QLnp68AxE9s2mCK.png)
...
- 图示
  ...
  ![image-20210820221949064](https://i.loli.net/2021/08/21/E5zO3juXCDvs2f9.png)
...
- **图示**
  ...
  ![image-20210820222317674](https://i.loli.net/2021/08/21/8VwcAGXHSk7b5Oo.png)
...
- **实现登录原理**![image-20210820222526944](https://i.loli.net/2021/08/21/dUjxyz9rLS4AqW5.png)
...
- 图示![image-20210820222541125](https://i.loli.net/2021/08/21/fvzMt51Go9wyjQ3.png)
...
- 设置每页数量
- 计算总页数
- 图示![image-20210820222618175](https://i.loli.net/2021/08/21/IPsqr2Lx7Hg8URO.png)
...
![image-20210820222652312](https://i.loli.net/2021/08/21/JCDtvUM9kWgd8yG.png)
...
- 图示
- ![image-20210820222743576](https://i.loli.net/2021/08/21/4fyduQBs1Hq76LT.png)

### 文件读取(图片预览)

- 图示
- ![image-20210820222822074](https://i.loli.net/2021/08/21/SNRqc2opMien6Qd.png)
- 代码![image-20210820222834084](https://i.loli.net/2021/08/21/LMr1TFeKSl4Gk26.png)
...
- 如何区分
	...
	- 图示![image-20210820223051645](https://i.loli.net/2021/08/21/Cdu5ZkXqSDnE6Q8.png)
	- 获取系统环境变量

		- **process.env.NODE_ENV**
		- 图示![image-20210820223104495](https://i.loli.net/2021/08/21/dhmX4PinqrbyeGF.png)
