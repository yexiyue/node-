...
![image-20210820213322067](./1/img/image-20210820213322067.png)
...
- 请求地址
  ...
  ![image-20210820213521158](./1/img/image-20210820213521158.png)

  代码![image-20210820213537297](./1/img/image-20210820213537297.png)
...
- 引用内置模块
	...
	- **const {pathname,query}=url.parse(req.url,true)**
		...
		- pathname地址ming
		- query传输来的数据
- 代码![image-20210820213842390](./1/img/image-20210820213842390.png)
- **post请求参数**
  - 参数被放置在请求体中进行传输
...
![image-20210820214036146](./1/img/image-20210820214036146.png)
...
- 代码![image-20210820214139697](./1/img/image-20210820214139697.png)
...
- 回调函数
  ...
  - 自己定义函数让别人去调用。
  - ![image-20210820214529390](./1/img/image-20210820214529390.png)
...
- 执行顺序
	...
	- 先同步后异步
	- ![image-20210820214545196](./1/img/image-20210820214545196.png)
	
	- ![image-20210820214614575](./1/img/image-20210820214614575.png)

### 4.回调地狱

- 异步api解决顺序问题只能用回调函数嵌套
- 因此容易导致回调地狱
- ![image-20210820214645915](./1/img/image-20210820214645915.png)
...
- 例子![image-20210820214707815](./1/img/image-20210820214707815.png)
...
- **await关键字**
	...
	- 代码![image-20210820214741923](./1/img/image-20210820214741923.png)

- **promisify方法**
	- **改造现有异步函数api让其返回promise对象从而支持异步函数语法**
	- **const promisify = require( ' util' ). promisify;**
	- 代码![image-20210820214757376](./1/img/image-20210820214757376.png)
...
- **使用mongoose提供的connect方法即可连接数据库。**
	...
	- 代码![image-20210820214931730](./1/img/image-20210820214931730.png)
...
- **在MongoDB中不需要显式创建数据库，如果正在使用的数据库不存在，MongoDB会自动创建。**
  ...
  **1.创建集合**
  ...
  代码![image-20210820215008214](./1/img/image-20210820215008214.png)
  ...
  **2.创建文档**
  ...
  - 第一种方法![image-20210820215021187](./1/img/image-20210820215021187.png)
  - **常用**（第二种方法）![image-20210820215031991](./1/img/image-20210820215031991.png)
  ...
  **4.查询数据**
  ...
  - **skip 跳过多少条数据limit 限制查询数量**
    ...
    ![image-20210820220351500](./1/img/image-20210820220351500.png)
  ...
  **7.验证字段**
  ...
  - 代码![image-20210820220808279](./1/img/image-20210820220808279.png)
  - 获取错误信息![image-20210820220842049](./1/img/image-20210820220842049.png)
  ...
  **8.集合关联**
  ...
  - ![image-20210820220908192](./1/img/image-20210820220908192.png)

  - **代码**

    ![image-20210820220930254](./1/img/image-20210820220930254.png)
...
- ![image-20210820221917093](./1/img/image-20210820221917093.png)
- 图示![image-20210820221929372](./1/img/image-20210820221929372.png)
...
- 图示
  ...
  ![image-20210820221949064](./1/img/image-20210820221949064.png)
...
- **图示**
  ...
  ![image-20210820222317674](./1/img/image-20210820222317674.png)
...
- **实现登录原理**![image-20210820222526944](./1/img/image-20210820222526944.png)
...
- 图示![image-20210820222541125](./1/img/image-20210820222541125.png)
...
- 设置每页数量
- 计算总页数
- 图示![image-20210820222618175](./1/img/image-20210820222618175.png)
...
![image-20210820222652312](./1/img/image-20210820222652312.png)
...
- 图示
- ![image-20210820222743576](./1/img/image-20210820222743576.png)

### 文件读取(图片预览)

- 图示
- ![image-20210820222822074](./1/img/image-20210820222822074.png)
- 代码![image-20210820222834084](./1/img/image-20210820222834084.png)
...
- 如何区分
	...
	- 图示![image-20210820223051645](./1/img/image-20210820223051645.png)
	- 获取系统环境变量
